...
#include "../common/window_desc.hpp"
...
class Window
{
  public:
    ...
    void trackEventsAsync(const std::function<void(const mapp::Event e)>& fun);
  ...
  protected:
    ...
    void executeEventCallback(const mapp::Event e);

    std::function<void(const mapp::Event e)> mCallback;
