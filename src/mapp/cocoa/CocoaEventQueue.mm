#include "mapp/cocoa/CocoaEventQueue.h"
                ...
                case NSEventTypeLeftMouseDown:
                    curEvent = Event(
                                     MouseInputData(
                                                    ...
                                                    mapp::ModifierState(nsEvent.modifierFlags & NSEventModifierFlagControl, nsEvent.modifierFlags & NSEventModifierFlagOption,
