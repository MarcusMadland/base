#include "mapp/Win32/WIN32_event_queue.hpp"
#include "mapp/common/window.hpp"
...
LRESULT EventQueue::pushEvent(MSG msg, Window* window)
{
    ...
    // TODO: hwnd to mapp::Window unordered_map, when mapp::Window closes, it
    // sends a message to the event queue to remove that hwnd
    // and any remaining events that match that mapp::Window
    ...
    mapp::Event e = mapp::Event(mapp::EventType::None, window);

    switch (message)
    {
    case WM_CREATE:
    {
        e = mapp::Event(mapp::EventType::Create, window);
        break;
    }
    case WM_PAINT:
    {
        ...
        e = mapp::Event(mapp::EventType::Paint, window);
        break;
    }
    case WM_ERASEBKGND:
    {
    ...
    case WM_DESTROY:
    {
        e = mapp::Event(mapp::EventType::Close, window);
        break;
    }
    case WM_SETFOCUS:
    {
        e = mapp::Event(mapp::FocusData(true), window);
        break;
    }
    case WM_KILLFOCUS:
    {
        e = mapp::Event(mapp::FocusData(false), window);
        break;
    }
    ...
    case WM_MOUSEWHEEL:
    {
        ...
        e = mapp::Event(
            mapp::MouseWheelData(
                ...
                mapp::ModifierState(modifiers & MK_CONTROL, modifiers & MK_ALT,
    ...
    case WM_INPUT:
    {
        ...
        else if (raw->header.dwType == RIM_TYPEMOUSE)
        {
            ...
            e = mapp::Event(
                mapp::MouseRawData(static_cast<int>(raw->data.mouse.lLastX),
    ...
    case WM_SYSKEYUP:
    {
        ...
        {
            e = mapp::Event(KeyboardData(d, ButtonState::Pressed, ms), window);
        }
        else if (message == WM_KEYUP || message == WM_SYSKEYUP)
        {
            e = mapp::Event(KeyboardData(d, ButtonState::Released, ms), window);
        }
        break;
    }
    case WM_SIZE:
    {
        ...
        e = mapp::Event(ResizeData(width, height, false), window);
        break;
    }
    case WM_SIZING:
    {
        ...
        e = mapp::Event(ResizeData(width, height, true), window);
        result = WVR_REDRAW;
        break;
    }
    case WM_MOVING:
    ...
    case WM_DPICHANGED:
    {
        ...
        e = mapp::Event(DpiData(fscale), window);
